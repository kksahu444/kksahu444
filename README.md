...
**CSE @ IIT Kharagpur.** I build systems close to the metal, and the services that run on top of them.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kksahu444/)
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:krishnkantsahu102@gmail.com)
[![PyPI](https://img.shields.io/badge/PyPI-3775A9?style=flat-square&logo=pypi&logoColor=white)](https://pypi.org/project/crashlens/)

</div>

- **Systems and low-latency C/C++**: lock-free ring buffers, epoll, `io_uring`, custom allocators
- **Databases from scratch**: B+ Tree indexes, ARIES WAL recovery, MVCC, query planning
- **ML infrastructure**: PEFT adapters written from scratch, LLM evaluation, geospatial pipelines
